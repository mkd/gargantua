...
bool setPosition(const string &fenStr) {
  /*
  ...
  */
  ...
  // VALIDATION: Ensure both sides have a King to prevent segfaults during
  // search/eval.
  if (!bitboards[K] || !bitboards[k]) {
...
void printBoard() {
  ...
  cout << "  Epsq:   " << ((epsq != NoSq) ? SquareToCoordinates[epsq] : "-")
       << endl;
