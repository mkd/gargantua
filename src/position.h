...
#define FenPosEmpty "8/8/8/8/8/8/8/8 b - - "
#define FenPosStartpos                                                         \
  "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
#define FenPosKiwipete                                                         \
  "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - "
#define FenPos3 "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - "
#define FenPos4                                                                \
  "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1"
#define FenPos5 "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8"
#define FenPos6                                                                \
...
static std::map<int, unsigned char> PromoPieces = {{Q, 'q'}, {R, 'r'}, {B, 'b'},
                                                   {N, 'n'}, {q, 'q'}, {r, 'r'},
                                                   {b, 'b'}, {n, 'n'}};
...
void resetBoard();
void printBoard();
bool setPosition(const std::string &);
std::string getFEN();
...
static inline bool isDraw() {
  ...
  // Draw if we have bishops and they are ALL on the same color (and no other
  // pieces)
  Bitboard allBishops = bitboards[B] | bitboards[b];
  if (allBishops &&
      !((allBishops & LightSquares) && (allBishops & DarkSquares))) {
...
static inline bool noMajorsOrMinors() {
  return !(countBits(occupancies[Both]) - countBits(bitboards[P]) -
           countBits(bitboards[p]) - 2);
}
